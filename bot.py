...
while True:
    for event in longpoll.listen():
        if(minutes()%5==0):    
            ...
            vk_session.method('wall.post', {'owner_id': '-163915966','message': "#1server.Продам халупу в новом районе Восточного поселка, ближе к ЦГБ. Гос: 1кк, доплату предлагайте в лс.\nРассматриваю предложения на автомобиль. Тонер старый - 108%.","attachment":"photo-177844818_457239078"})
            time.sleep(60)
